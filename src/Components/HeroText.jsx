    ...
    >
      <LazyMotion features={domAnimation} strict>
          ...
          >
            {name.split("").map((char, index) => {
              ...
              return (
                <span
                  key={index}
                  className="text-primary-550 bounce"
        ...
        <m.span
          ...
          whileInView={{ y: 0 }}
          transition={{ duration: 0.6, type: "spring" }}
          className="cursor-pointer text-4xl sm:text-5xl underline underline-offset-4 decoration-primary-550"
          id="repulse-span"
          style={{ fontFamily: "Morganite Extra Bold, sans-serif" }}
        >
        <a href="#about">
          <span className="text-primary-550">Project positions and </span> HSE Officer
        </a>
        </m.span>
      </LazyMotion>
    </div>
