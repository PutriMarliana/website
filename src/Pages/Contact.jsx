    ...
    >
        ...
        <div className="w-full flex justify-center items-center">
          <LazyMotion features={domAnimation} strict>
            <m.div
              ...
              className="w-full sm:w-[90%] md:w-[80%] sm:h-[600px] rounded-xl border-4 border-primary-550 p-4 flex flex-col sm:flex-row gap-4"
            >
              <ContactServices />
              <ContactForm />
            </m.div>
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="bg-grayscale-950 flex justify-center pb-4 text-grayscale-400">
          <span>
            Created by <em>Putri Marliana Hamzah</em>
          </span>
        </div>
      </div>
    </div>
